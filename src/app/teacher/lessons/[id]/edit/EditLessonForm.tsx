...
export default function EditLessonForm({ lesson }: EditLessonFormProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Update &ldquo;{lesson.title}&rdquo;</p>
        </div>
      </div>
